...
export default function Confidentialite() {
  return (
    ...
    >
      ...
      <h2>Base légale</h2>
      <p>
        Le traitement repose sur l&apos;intérêt légitime de Capstone
        Strategies à répondre aux demandes qui lui sont adressées, au sens de
        l&apos;article 6.1.f du RGPD, et le cas échéant sur les mesures
        précontractuelles prises à la demande de la personne, au sens de
        l&apos;article 6.1.b.
      </p>
      ...
      <p>
        ...
        puis supprimées. Celles qui se rattachent à une mission conclue suivent
        la durée de conservation du dossier de mission.
      </p>
      ...
      <p>
        Le site est hébergé par Vercel Inc., aux États-Unis. Les transferts
        hors de l&apos;Union européenne sont encadrés par le Data Privacy
        Framework ou par les clauses contractuelles types de la Commission
        européenne.
      </p>
